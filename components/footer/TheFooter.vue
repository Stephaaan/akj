    ...
    <div v-if="footerData" class="w-100 flex flex-col sm:flex-row items-center justify-center my-8">
      <div class="flex flex-col sm:flex-row sm:mr-8">
        ...
        <div class="flex flex-col">
          ...
          <div class="max-w-3xs sm:max-w-2xs font-worksansLight font-hairline text-base sm:text-xl text-center">
      ...
      <div class="flex h-full flex-col justify-around font-hairline">
        ...
        <div class="flex flex-row my-2">
          ...
          <div class="flex items-center">
            <a :href="`tel:${footerData.telefonne_cislo_klikatelne}`" class="cursor-pointer">{{ footerData.telefonne_cislo_citatelne }}</a>
          </div>
        </div>
        <div class="flex flex-row my-2">
          <div>
          ...
          <div class="flex items-center">
            <a :href="`mailto:${footerData.mail}`" class="cursor-pointer">{{ footerData.mail }}</a>
          </div>
        </div>
      </div>
    </div>
